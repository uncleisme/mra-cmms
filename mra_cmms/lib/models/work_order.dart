class WorkOrder {
  ...
  factory WorkOrder.fromMap(Map<String, dynamic> map) => WorkOrder(
        ...
        createdDate: map['created_date'] != null ? DateTime.tryParse(map['created_date'].toString()) : null,
        ...
        recurrenceStartDate: map['recurrence_start_date'] != null ? DateTime.tryParse(map['recurrence_start_date'].toString()) : null,
        recurrenceEndDate: map['recurrence_end_date'] != null ? DateTime.tryParse(map['recurrence_end_date'].toString()) : null,
        nextScheduledDate: map['next_scheduled_date'] != null ? DateTime.tryParse(map['next_scheduled_date'].toString()) : null,
